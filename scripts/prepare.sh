...
echo "setup.sh creates a fresh sibling chatbot_offline deployment each time."
echo "Updates: unzip the new chatbot.zip over chatbot, copy changed archives from"
echo "$ARCHIVE_OUTPUT_DIR into chatbot/images/, then run chatbot/setup.sh."
